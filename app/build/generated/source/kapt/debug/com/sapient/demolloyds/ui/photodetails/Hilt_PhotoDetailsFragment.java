...
public abstract class Hilt_PhotoDetailsFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhotoDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPhotoDetailsFragment(UnsafeCasts.<PhotoDetailsFragment>unsafeCast(this));
    }
  }
